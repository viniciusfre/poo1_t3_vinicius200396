...
public class Main6 {
    public static void main(String[]args){
    	...
    	Figurinha4 figNormal = new Figurinha4("Felipe",LocalDate.parse("2003-04-12"),1.73f,70.0f,"centro-avante","Brazil");
    	FigExtras2 figLegend = new FigExtras2("Thiago",LocalDate.parse("2003-04-12"),1.73f,70.0f,"centro-avante","Brazil","Legend", "Bordô");
