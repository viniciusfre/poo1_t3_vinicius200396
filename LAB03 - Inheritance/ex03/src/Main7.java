...
public class Main7 {
    public static void main(String[]args){
    	...
    	Figurinha5 figNormal = new Figurinha5("Felipe",LocalDate.parse("2003-04-12"),1.73f,70.0f,"centro-avante","Brazil");
    	FigExtras3 figLegend = new FigExtras3(figNormal, "Legend", "Bordô");
